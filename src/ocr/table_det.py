"""
TODO look into these resources:
...
- https://pyimagesearch.com/2022/02/28/multi-column-table-ocr/ WITH THIS TUTORIAL

- https://nanonets.com/blog/table-extraction-deep-learning/

pattern matching
- https://stackoverflow.com/questions/63395631/detect-a-table-part-from-entire-image-in-python
...
for (l, _) in sortedClusters:
	...
	color = [int(c) for c in color] # loop over the sorted indexes
	for i in sortedIdxs:
		(x, y, w, h) = coords[i]
